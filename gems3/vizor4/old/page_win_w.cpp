//-------------------------------------------------------------------
// $Id: page_win_w.cpp 968 2007-12-13 13:23:32Z gems $
//
        ...
        rInfo(i)
{
    ...
    pPackKey->setFrameStyle( Q3Frame::Box | Q3Frame::Raised );
...
//    pRTime->move(pos + szFButton + 4 + 100, 1);	// moved in ShowInfo
    ...
    pRTime->setFrameStyle( Q3Frame::Box | Q3Frame::Raised );
