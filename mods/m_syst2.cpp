...
// type = 1 only Multy, 2 - System&Mtparm, 3 All
TCIntArray
TSysEq::getDBObjectList( int type )
{
  int i;
  TCIntArray arr;

  if( type >=2   ) //System
    for(  i=o_symass; i<o_syvuns+1; i++ )
    {
      if( aObj[i].IsNull())
       continue;
