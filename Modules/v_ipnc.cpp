...
void IPNCalc::eq_add( int Item, int First )
{
    ...
    {
        int Indx = aEq.size()-1;
        aEq[Indx].nItems = Item - aEq[Indx].first;
...
// skip string const "<ᨬ����>", in struct put
...
#define StackEnd( i ) (*(aStack.end()-1+i))
#define StackDel() (aStack.pop_back())
