...
protected:
    ...
    void MakeRecordLists( const vector<string>& AqKey,
...
public:
    ...
    void DCListLoad( const vector<string>& AqKey,
                     const vector<string>& GasKey );
    void ICmake();
    void PHmake();
    void TestIComp();
    void LoadRmults( bool NewRec, bool changePhases );
    void SelectAqGasPhase( char AqGasType, vector<string>& AqGasKey );
    //void SelectAqPhase(vector<string> dfKey );
    //void SelectGasPhase(vector<string> dfKey );
