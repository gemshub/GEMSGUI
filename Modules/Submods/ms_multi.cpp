...
//    aObj[ o_wo_masdj ].SetDim( pm.Ls, 1 );
    ...
    aObj[ o_wo_bfc ].SetDim( pm.N, 1 );// corrected 07.07.2013 for correct use in scripts
...
//    pm.rcpc   = (double *)aObj[ o_wi_rcpc].GetPtr();
    ...
    pm.ocPRkC   = (long int (*)[2])aObj[ o_wi_ocprkc].GetPtr();
    pm.feSArC   = (double *)aObj[ o_wi_fsac].GetPtr();
    pm.rpConC   = (double *)aObj[ o_wi_krpc].GetPtr();
    pm.apConC   = (double *)aObj[ o_wi_apconc].GetPtr();
...
//  new
    pm.PfFact   = (double *)aObj[ o_wi_pffact ].Free();
...
//    pm.rcpc   = (double *)aObj[ o_wi_rcpc].Free();
    ...
    pm.ocPRkC   = (long int (*)[2])aObj[ o_wi_ocprkc].Free();
    pm.feSArC   = (double *)aObj[ o_wi_fsac].Free();
    pm.rpConC   = (double *)aObj[ o_wi_krpc].Free();
    pm.apConC   = (double *)aObj[ o_wi_apconc].Free();
