...
//  Status and control flags (+ -)
   ...
   PsSdat, //  Save DataCH and inital DataBR files as binary (+) or json (-)
...
#endif
{
    ...
    GraphWindow* gd_gr;
    TPlotLine* plot;
    string title;           // changed titler to title
#endif
...
public:
    ...
    string   GetKeyofRecord( const char *oldKey, const char *strTitle,
                              int keyType );
   ...
   void InsertChanges( const vector<CompItem>& aIComp,
