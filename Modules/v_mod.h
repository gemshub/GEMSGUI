...
enum param_objects {                  // work objects
    // RMULTS
    o_muphc = o_lms_paf+1, o_mudcc, /*o_mudcs,*/ o_muicc,  o_mudcf,
...
o_nldcvs, o_nldchs, o_nlphv, o_nlphh, // new !!!
    ...
    o_tpbet,   o_tpwbor, o_tpwrad, o_tpfug,  o_tpdvg, o_tpdcmod,
    // SYSTEM built-in
    ...
    o_wi_satndx, o_wi_dul,  o_wi_dll,  o_wi_gex,  o_wi_pul, o_wi_pll, o_wi_yof,
          o_wi_pffact, o_wo_prto, o_wo_pkto, o_wo_pvto, o_wo_emrd, o_wo_emdf,
    ...
    o_wd_icwm,  o_wo_bf, o_wo_bfc, o_wo_bfc3, o_w_xf ,  o_wo_yf,  o_ww_xfa,
    ...
    o_wi_dcmod,  o_wd_sb,  o_wd_sm,  o_wd_sf,  o_wd_sfs,
    o_wd_sm2,
o_wd_sm3,  //  new
    o_wd_sf2, o_wd_txtb,
...
// TSolMod stuff
o_wi_lphc, o_wi_dqfc, o_wi_rcpc, o_wi_lndqft_res, o_wi_lnrcpt_res,
o_wi_lnexet_res, o_wi_lncnft_res,
...
o_ngte, o_nhte, o_nste, o_nvte, o_ncpte, o_nate, o_nute,
    // Added EJDBHead
    o_paver,
    // BASE_PARAM
    ...
    o_patppvc, o_pasyppc,    o_pasypvc, o_pautppc,  o_papepsc,
...
enum icomp_objects {                  // work objects
    o_icawt= o_sptext+1, o_icass, o_icacp,
...
enum DC_CNTRL_CODES {
    ...
    CPM_NUL = '0',   // account for pressure dependence is already specified as inherent to a method
    CPM_ONE = '1',   // V0
    CPM_TWO = '2',
    CPM_TRI = '3',
    CPM_CON = 'C',   // molar volume of DC or dVr are assumed independent of P and T
    CPM_VKE = 'K',   // molar volume from empirical V=f(T,P) equation (Dorogokupets et al., 1988)
    CPM_VBE = 'V',   // molar volume from empirical  V=f(T,P) equation (Berman, 1988)
    CPM_VBM = 'B',   // molar volume from Birch-Murnaghan EoS (Gottschalk, 1997)
    CPM_CEH = 'E',   // molar volume V(T,P) from Murnaghan EoS (Holland and Powell, 1998)
    CPM_VTA = 'H',   // molar volume V(T,P) from Tait EoS (Holland and Powell, 2011)
    CPM_GAS = 'G',   // calculation of fugacities of gases from their critical parameters (reserved)
    ...
    CPM_STP = '6',   // Sterner-Pitzer (SP) EoS for fluids (nonelectrolytes) (reserved)
    ...
    CPM_REFL = '9',  // reference EoS model for fluids (nonelectrolytes) (reserved)
    ...
    CEM_GAS = 'G',   // generic fluid model routine
    CEM_H2O = 'V',   // subroutine for H2O fluid
    CEM_CO2 = 'C',   // subroutine for CO2 fluid
    CEM_CH4 = 'M',   // subroutine for CH4 fluid
    CEM_N2 = 'T',    // subroutine for N2 fluid
    CEM_H2 = 'H',    // subroutine for H2 fluid
...
enum gem2mt_objects {
  o_mtpufl = o_dtsdpar+1, o_mtpvfl, o_mtpsfl, o_mtnc, o_mtnv,
  ...
  /*o_mtaxis,*/ o_mtpai,  o_mttai,  o_mttau,  o_mtsizelc,
    o_mtctm,  o_mtcnv, o_mtqc, o_mtkv, o_mtjqc,
    o_mtjqs,  o_mtjt,  o_mtjdd, o_mtjdi, o_mtide,
    o_mtct_, o_mtrei5,
    o_mtct, o_mtcp, o_mtcv,  o_mtctau, o_mtdtau,
    o_mtotau, o_mtdx, o_mtref2, o_mtref3, o_mtref4,
    // DBase 67
  o_mtname, o_mtnotes, o_mtflag, o_mtshort, o_mtaxis,
  o_mtworks, o_mtworkf, o_mtdoudl, o_mtadpar, o_mtfloat,
  o_mtsize,  o_mtxnames, o_mtynames, o_mtlnam, o_mtlname,
  o_mttexpr, o_mtgexpr, o_mtsdref, o_mtsdval, o_mtdicp,
  o_mt_xic,  o_mt_xdc, o_mt_xph,  o_mtfdli,  o_mtptvi,
  o_mtstap,  o_mtxflds, o_mtxet,  o_mtyet, o_mtddc,
  o_mtdic,  o_mtdel,  o_mtbn, o_mthydp, o_mtbsf,
  o_mtmb,  o_mtdmb,  o_mtqpi,  o_mtqpc, o_mtxt,
  o_mtyt,  o_mtcib,  o_mtcab, o_mtfdlf, o_mtpgt,
  o_mttval, o_mtpval, o_mtnam_i, o_mtfor_i, o_mtfor_e,
  o_mtstld, o_mtciclb, o_mtaucln, o_mtfdlid, o_mtfdlop,
  o_mtfdlmp, o_mtmpgid, o_mtumpg,  o_mtbm, o_mtgrid,
  o_mtnpmean, o_mtnpmin, o_mtnpmax, o_mtpartd,  o_mtres1,
  o_mtres2, o_mtplline,
//work
  o_mtsykey, o_mtan, o_mtae,  o_mtgfc,  o_mtyfb, o_mttt,
  o_mwetext, o_mwtprn
};

enum CHstruct_objects {  // data objects from DataCH structure for GEM2MT scripts
  o_ch_nicb = o_mwtprn+1, o_ch_ndcb, o_ch_nphb, o_ch_npsb,
