...
o_nldcvs, o_nldchs, o_nlphv, o_nlphh, // new !!!
    ...
    o_w_hym__, o_w_vl,  o_wi_mm,  o_wio_h0,  o_wio_a0,
    o_wio_u0, o_wio_s0,  o_wio_cp0,  o_wio_cv0__,  o_wi_pparc,
...
// DBase 67
  ...
  o_mt_xdc, o_mt_xph,  o_mtfdli,  o_mtptvi,   o_mtstap,
  o_mtxflds, o_mtxet,  o_mtyet, o_mtddc, o_mtdic,
  o_mtdel,  o_mtbn, o_mthydp, o_mtbsf, o_mtmb,
  o_mtdmb,  o_mtqpi,  o_mtqpc, o_mtxt, o_mtyt,
  o_mtcib,  o_mtcab, o_mtfdlf, o_mtpgt, o_mttval,
  o_mtpval, o_mtnam_i, o_mtfor_i, o_mtfor_e, o_mtstld,
  o_mtciclb, o_mtaucln, o_mtfdlid, o_mtfdlop, o_mtfdlmp,
  o_mtmpgid, o_mtumpg,  o_mtbm, o_mtgrid, o_mtnpmean,
  o_mtnpmin, o_mtnpmax, o_mtpartd,  o_mtres1, o_mtres2,
  o_mtplline,
//work
  o_mtsykey, o_mtan, o_mtae,  o_mtgfc,  o_mtyfb, o_mttt,
  o_mwetext, o_mwtprn, o_mtctm,  o_mtcnv,
  o_mtqc, o_mtkv, o_mtjqc, o_mtjqs,  o_mtjt,
  o_mtjdd, o_mtjdi, o_mtide, o_mtct_, o_mtqf,
