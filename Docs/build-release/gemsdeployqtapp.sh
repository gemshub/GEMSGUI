...
tardir=Gems3-app
gemsdistro=Gems3.7.0-b053eed.fdcdd2b-linux-x86-64-ubuntu.tgz
mkdir $tardir
...
dep=$HOME/Qt/5.12.7/gcc_64/lib/libQt5Concurrent.so.5
cp $dep $libsdir
dep=$HOME/Qt/5.12.7/gcc_64/lib/libQt5DBus.so.5
cp $dep $libsdir
dep=$HOME/Qt/5.12.7/gcc_64/lib/libQt5Xml.so.5
cp $dep $libsdir
dep=$HOME/Qt/5.12.7/gcc_64/lib/libQt5Sql.so.5
cp $dep $libsdir
dep=$HOME/Qt/5.12.7/gcc_64/lib/libQt5Charts.so.5
cp $dep $libsdir
dep=$HOME/Qt/5.12.7/gcc_64/lib/libQt5Help.so.5
cp $dep $libsdir
dep=$HOME/Qt/5.12.7/gcc_64/lib/libQt5X11Extras.so.5
cp $dep $libsdir
...
qtplatformplugin=$HOME/Qt/5.12.7/gcc_64/plugins/platforms/*.so
...
qtplatformthemesplugin=$HOME/Qt/5.12.7/gcc_64/plugins/platformthemes/*.so
qtplatformthemesplugindir=$tardir/platformthemes
mkdir $qtplatformthemesplugindir
echo "Created platformthemes directory: "$qtplatformthemesplugindir
cp $qtplatformthemesplugin $qtplatformthemesplugindir
echo "Copied platformthemes "$qtplatformthemesplugin" to "$qtplatforthemesmplugindir

qtxcbglintegrationsplugin=$HOME/Qt/5.12.7/gcc_64/plugins/xcbglintegrations/*.so
qtxcbglintegrationsplugindir=$tardir/xcbglintegrations
mkdir $qtxcbglintegrationsplugindir
echo "Created xcbglintegrations plugin directory: "$qtxcbglintegrationsplugindir
cp $qtxcbglintegrationsplugin $qtxcbglintegrationsplugindir
echo "Copied xcbglintegrations "$qtxcbglintegrationsplugin" to "$qtxcbglintegrationsplugindir
...
qtsqliteplugin=$HOME/Qt/5.12.7/gcc_64/plugins/sqldrivers/*.so
...
qtbearerplugin=$HOME/Qt/5.12.7/gcc_64/plugins/bearer/*.so
...
qticonenginesplugin=$HOME/Qt/5.12.7/gcc_64/plugins/iconengines/*.so
...
qtprintsupportplugin=$HOME/Qt/5.12.7/gcc_64/plugins/printsupport/*.so
...
qtimageformatsplugin=$HOME/Qt/5.12.7/gcc_64/plugins/imageformats/*.so
...
#qtstylesplugin=$HOME/Qt/5.12.7/gcc_64/plugins/styles/*.so
...
qtqcollectiongenerator=$HOME/Qt/5.12.7/gcc_64/bin/qcollectiongenerator
cp $qtqcollectiongenerator $tardir
echo "Copied executable "$qtqcollectiongenerator" to "$tardir
qtqhelpgenerator=$HOME/Qt/5.12.7/gcc_64/bin/qhelpgenerator
...
echo "================================================================================" >> $readme
echo "GEM-Selektor v.3.7.0 $etardir bult on linux $distro" >> $readme
