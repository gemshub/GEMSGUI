...
qtfontsdir=$HOME/Qt/5.12.0/Src/qtbase/lib/fonts
...
qtplatformplugin=$HOME/Qt/5.12.0/gcc_64/plugins/platforms/*.so
...
qtsqliteplugin=$HOME/Qt/5.12.0/gcc_64/plugins/sqldrivers/*.so
...
qtbearerplugin=$HOME/Qt/5.12.0/gcc_64/plugins/bearer/*.so
...
qtprintsupportplugin=$HOME/Qt/5.12.0/gcc_64/plugins/printsupport/*.so
...
qtimageformatsplugin=$HOME/Qt/5.12.0/gcc_64/plugins/imageformats/*.so
...
qtqcollectiongenerator=$HOME/Qt/5.12.0/gcc_64/bin/qcollectiongenerator
cp $qtqcollectiongenerator $tardir
echo "Copied executable "$qtqcollectiongenerator" to "$tardir
qtqhelpgenerator=$HOME/Qt/5.12.0/gcc_64/bin/qhelpgenerator
...
echo "================================================================================" >> $readme
echo "GEM-Selektor v.3.4.4 $etardir bult on linux $distro" >> $readme
