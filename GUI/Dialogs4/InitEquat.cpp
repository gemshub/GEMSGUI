...
void GetListsnRT( int nRT, TIArray<pagesSetupData>& wnData, TIArray<pagesSetupData>& scalarsList )
{
  ...
  {
  case RT_ICOMP:
     scalarsList.Add( new pagesSetupData("M0i",o_icawt));  //"Atomic (molar) mass of Independent Component "
     scalarsList.Add( new pagesSetupData("S0i", o_icass)); //"Standard-state absolute entropy S0 per g/atom "
 //    scalarsList.Add( new pagesSetupData("Cp0i",o_icacp)); //"Standard-state absolute heat capacity Cp0 per g/atom (reserved) "
 //    scalarsList.Add( new pagesSetupData("V0i",o_icavs));  //"Standard state volume V0 per g/atom (reserved) "
 //    scalarsList.Add( new pagesSetupData("Ri",o_icarad));  //"Ionic radius Angstrom (reserved) "
     scalarsList.Add( new pagesSetupData("IXi",o_icidis));  //"Relative isotope abundance (1 for chemical elements) "
     scalarsList.Add( new pagesSetupData("Valen",o_icval)); //"Default valence number (formula charge) of IC in compounds "
     scalarsList.Add( new pagesSetupData("indMT",o_icnum)); //"Index in Periodical (Mendeleev's) Table of chemical elements "
//     scalarsList.Add( new pagesSetupData("Zi",o_iccoor));   //"Default coordination number in compounds (reserved) "
     break;

  case RT_DCOMP:
     scalarsList.Add( new pagesSetupData("Zz",o_dczz));  //"Formula charge of this species (Dependent Component) "
     scalarsList.Add( new pagesSetupData("M0",o_dcmwt));  //"Molecular (gram-formula) mass, g/mol "
     scalarsList.Add( new pagesSetupData("V0d[0]",o_dcmvs));  //"Molar volume V0 of Dependent Component at standard state (J/bar)_
//     scalarsList.Add( new pagesSetupData("V0d[1]",o_dcmvs,1));  // Uncertainty of V0 (J/bar) "
     scalarsList.Add( new pagesSetupData("G0d[0]",o_dcgs)); //"Standard molar (partial molal) Gibbs energy of formation of DC from IC at Tr and Pr_
//     scalarsList.Add( new pagesSetupData("G0d[1]",o_dcgs,1)); // Uncertainty of standard molar (partial molal) Gibbs energy of formation G0u "
     scalarsList.Add( new pagesSetupData("H0d[0]",o_dchs)); // "Molar (partial molal) enthalpy of formation of DC from IC at standard state and Tr, Pr_
//     scalarsList.Add( new pagesSetupData("H0d[1]",o_dchs,1)); // Uncertainty of standard state molar enthalpy H0 (J/mol) "
     scalarsList.Add( new pagesSetupData("S0d[0]",o_dcss)); // "Absolute molar (partial molal) entropy of Dependent Component at the standard state_
//     scalarsList.Add( new pagesSetupData("S0d[1]",o_dcss,1)); //  Uncertainty of standard molar (partial molal) absolute entropy of formation "
     scalarsList.Add( new pagesSetupData("Cp0d[0]",o_dccps)); // "Absolute molar (partial molal) isobaric heat capacity Cp0 of DC at standard state and reference Tr, Pr_
//     scalarsList.Add( new pagesSetupData("Cp0d[1]",o_dccps,1)); //  Uncertainty of Cp0 at reference Tr, Pr "
//     scalarsList.Add( new pagesSetupData("PrTr[0]",o_dcptst)); //  "Reference pressure Pr (bar)_
//     scalarsList.Add( new pagesSetupData("PrTr[1]",o_dcptst,1)); //  Reference temperature Tr, C "
//     scalarsList.Add( new pagesSetupData("LamST[0]",o_dcstlam )); // "Entropy of lambda transition (J/K/mol), minerals only_
//     scalarsList.Add( new pagesSetupData("LamST[1]",o_dcstlam,1)); // Temperature of lambda transition (C), minerals only "
//     scalarsList.Add( new pagesSetupData("BetAlp[0]",o_dcbeal)); // "Coefficient of isothermal compressibility b_ (or CN/dentateness for surface species)
//     scalarsList.Add( new pagesSetupData("BetAlp[1]",o_dcbeal,1)); // Coefficient of isobaric expansibility a (or exponent parameter for surface species) "
     scalarsList.Add( new pagesSetupData("ab[0]", o_dcder)); // "Ion-size parameter ao (Debye-Hueckel) (or unit charge at zero plane for surface complexes)_
     scalarsList.Add( new pagesSetupData("ab[1]", o_dcder,1)); // Individual parameter b (optional) (or unit charge at the beta plane for surface complexes) "
     // dynamic
    scalarsList.Add( new pagesSetupData("TCint[0]", o_dccpint)); //"Lower temperature validity limit(s) for Cp = f (T) equation_
    scalarsList.Add( new pagesSetupData("TCint[1]", o_dccpint,1)); // Upper temperature validity limit(s) for Cp = f (T) equation "
    scalarsList.Add( new pagesSetupData("aiCpT[0]", o_dccp)); //  "Free term coefficient a0 of general Cp = f(T) equation_
    scalarsList.Add( new pagesSetupData("aiCpT[1]", o_dccp,1)); // Coefficient a1 of the a1*T term of general Cp = f(T) equation_
    scalarsList.Add( new pagesSetupData("aiCpT[2]", o_dccp,2)); // Coefficient a2  of the  a2*T^-2 term of general Cp = f(T) equation_
    scalarsList.Add( new pagesSetupData("aiCpT[3]", o_dccp,3)); // Coefficient a3  of the  a3*T^-0.5 term of general Cp = f(T) equation_
    scalarsList.Add( new pagesSetupData("aiCpT[4]", o_dccp,4)); // Coefficient a4  of the  a4*T^2 term of general Cp = f(T) equation_
    scalarsList.Add( new pagesSetupData("aiCpT[5]", o_dccp,5)); // Coefficient a5  of the  a5*T^3 term of general Cp = f(T) equation_
    scalarsList.Add( new pagesSetupData("aiCpT[6]", o_dccp,6)); // Coefficient a6  of the  a6*T^4 term of general Cp = f(T) equation_
    scalarsList.Add( new pagesSetupData("aiCpT[7]", o_dccp,7)); // Coefficient a7  of the  a7*T^-3 term of general Cp = f(T) equation_
    scalarsList.Add( new pagesSetupData("aiCpT[8]", o_dccp,8)); // Coefficient a8  of the  a8*T^-1 term of general Cp = f(T) equation_
    scalarsList.Add( new pagesSetupData("aiCpT[9]", o_dccp,9)); // Coefficient a9  of the  a9*T^0.5 term of general Cp = f(T) equation_
    scalarsList.Add( new pagesSetupData("aiCpT[10]", o_dccp,10)); //Coefficient a10  of the  a10*ln T term of general Cp = f(T) equation "
//    scalarsList.Add( new pagesSetupData("aiNEs[0]", o_dccpfs)); // "Empirical coefficients for non-electrolyte aqueous species "
    scalarsList.Add( new pagesSetupData("aiHKF[0]", o_dchkf)); // "Empirical coefficient a1 of the HKF EoS: cal/bar/mol_
    scalarsList.Add( new pagesSetupData("aiHKF[1]", o_dchkf)); // Empirical coefficient a2 of the HKF EoS: cal/mol_
    scalarsList.Add( new pagesSetupData("aiHKF[2]", o_dchkf)); // Empirical coefficient a3 of the HKF EoS: cal*K/bar/mol_
    scalarsList.Add( new pagesSetupData("aiHKF[3]", o_dchkf)); // Empirical coefficient a4 of the HKF EoS: cal*K/mol_
    scalarsList.Add( new pagesSetupData("aiHKF[4]", o_dchkf)); // Empirical coefficient c1 of the HKF EoS: cal/K/mol_
    scalarsList.Add( new pagesSetupData("aiHKF[5]", o_dchkf)); // Empirical coefficient c2 of the HKF EoS: cal*K/mol_
    scalarsList.Add( new pagesSetupData("aiHKF[6]", o_dchkf)); // wB Born factor of the HKF EoS: cal/mol_
//    scalarsList.Add( new pagesSetupData("aiVTP[0]", o_dcvt)); // "Coefficient  a0(T) of the molar volume equation_
//    scalarsList.Add( new pagesSetupData("aiVTP[1]", o_dcvt,1)); // Coefficient a1(T) of the molar volume equation_
//    scalarsList.Add( new pagesSetupData("aiVTP[2]", o_dcvt,2)); // Coefficient a2(T) of the molar volume equation_
//    scalarsList.Add( new pagesSetupData("aiVTP[3]", o_dcvt,3)); // Coefficient b0(P) of the molar volume equation_
//    scalarsList.Add( new pagesSetupData("aiVTP[4]", o_dcvt,4)); // Coefficient b1(P) of the molar volume equation "
//    scalarsList.Add( new pagesSetupData("CritPg[0]", o_dccritpg)); // "Critical temperature Tcr (K) for the PRSV fluid model_
//    scalarsList.Add( new pagesSetupData("CritPg[1]", o_dccritpg)); // Critical pressure Pcr (bar) for the PRSV fluid model_
//    scalarsList.Add( new pagesSetupData("CritPg[2]", o_dccritpg)); // Pitzer acentric factor W for the PRSV fluid model_
//    scalarsList.Add( new pagesSetupData("CritPg[3]", o_dccritpg)); // Parameter k1 for the PRSV fluid model_
//    scalarsList.Add( new pagesSetupData("CritPg[4]", o_dccritpg)); // Parameter k2 for the PRSV fluid model_
//    scalarsList.Add( new pagesSetupData("CritPg[5]", o_dccritpg)); // Parameter k3 for the PRSV fluid model_
    break;

  case RT_COMPOS:
    scalarsList.Add( new pagesSetupData("MasVol[0]",o_bcmvol)); // o_bcmvol  MasVol F_  1 8   N "Ms (input normalization mass, output total PCO mass)_
    scalarsList.Add( new pagesSetupData("MasVol[1]",o_bcmvol,1)); //     Vs (input normalisation volume, for specifying volume concentrations)_
    scalarsList.Add( new pagesSetupData("MasVol[2]",o_bcmvol,2)); //      Mw (input mass of water-solvent, for specifying molalities)_
    scalarsList.Add( new pagesSetupData("MasVol[3]",o_bcmvol,3)); //      Maq (input mass of aqueous solution for dissolved mass concentrations)_
    scalarsList.Add( new pagesSetupData("MasVol[4]",o_bcmvol,4)); //    Vaq (input volume of aqueous solution for molarities)_
    scalarsList.Add( new pagesSetupData("MasVol[5]",o_bcmvol,5)); //     Pg (input pressure in gas, for partial pressures)_
    scalarsList.Add( new pagesSetupData("MasVol[6]",o_bcmvol,6)); //      Ns (input total number of IC moles in this PCO)_
    scalarsList.Add( new pagesSetupData("MasVol[7]",o_bcmvol,7)); //     Mf (amount/concentration of compound specified by Ctext) "
// to discuss dynamic objects in Compos
    break;

  case RT_REACDC:
    scalarsList.Add( new pagesSetupData("Zz_",o_rezz));  // "Formula charge of a new species (Dependent Component) "
    scalarsList.Add( new pagesSetupData("M0_",o_remwt)); // "Molecular (gram-formula) mass of the new DC (species), g/mol "
    scalarsList.Add( new pagesSetupData("logKr[0]",o_reks)); // "Value of the equilibrium constant K of reaction at Tr,Pr_
    scalarsList.Add( new pagesSetupData("logKr[1]",o_reks,1)); // log K of reaction at Tr, Pr (for isotopic forms: 1000 ln(alpha) )_
//    scalarsList.Add( new pagesSetupData("logKr[2]",o_reks,2)); // Uncertainty of logK,  dev(logK) "
    scalarsList.Add( new pagesSetupData("G0r[0]",o_regs)); // "dGr - standard Gibbs energy effect of the reaction at Tr, Pr (J/mol)_
    scalarsList.Add( new pagesSetupData("G0r[1]",o_regs,1)); //  Standard molar (partial molal) Gibbs energy of formation G0 of new DC from IC at Tr and Pr (J/mol)_
 //   scalarsList.Add( new pagesSetupData("G0r[2]",o_regs,2)); // Uncertainty of G0,  dev(G0) (J/mol) "
    scalarsList.Add( new pagesSetupData("H0r[0]",o_rehs)); // "dHr - standard enthalpy effect of the reaction at Tr, Pr (J/mol)_
    scalarsList.Add( new pagesSetupData("H0r[1]",o_rehs,1)); //  Standard molar (partial molal) enthalpy of formation H0 of the new DC from IC at Tr and Pr (J/mol)_
 //   scalarsList.Add( new pagesSetupData("H0r[2]",o_rehs,2)); // Uncertainty of H0, dev(H0) (J/mol) "
    scalarsList.Add( new pagesSetupData("S0r[0]",o_ress)); //  "dSr - standard entropy effect of the reaction at Tr, Pr (J/K/mol)_
    scalarsList.Add( new pagesSetupData("S0r[1]",o_ress,1)); //  Absolute molar (partial molal) entropy S0 of  the new DC at standard state (J/K/mol)_
 //   scalarsList.Add( new pagesSetupData("S0r[2]",o_ress,2)); //  Uncertainty of S0, dev(S0) (J/K/mol) "
    scalarsList.Add( new pagesSetupData("Cp0r[0]",o_recps)); //    dCpr - standard isobaric heat capacity effect of the reaction at Tr, Pr (J/K/mol)_
    scalarsList.Add( new pagesSetupData("Cp0r[1]",o_recps,1)); //  Absolute molar (partial molal) isobaric heat capacity Cp0 of  the new DC at standard state (J/K/mol)_
 //   scalarsList.Add( new pagesSetupData("Cp0r[2]",o_recps,2)); //  Uncertainty of Cp0, dev(Cp0) (J/K/mol) "
    scalarsList.Add( new pagesSetupData("V0r[0]",o_remvs)); //   "Molar volume effect dVr of the reaction at Tr,Pr (J/bar)_
    scalarsList.Add( new pagesSetupData("V0r[1]",o_remvs,1)); //  Molar volume V0 of Dependent Component at standard state (J/bar)_
 //   scalarsList.Add( new pagesSetupData("V0r[2]",o_remvs,2)); //  Uncertainty of V0 dev(V0) (J/bar) "
 //   scalarsList.Add( new pagesSetupData("NisoX[0]",o_renix)); // "Mole fraction of counter-isotope in natural mixture (of chemical element)_
 //   scalarsList.Add( new pagesSetupData("PrTr_[0]",o_reptst)); // "Reference pressure Pr (bar)_
 //   scalarsList.Add( new pagesSetupData("PrTr_[1]",o_reptst,1)); // Reference temperature Tr (C) "
 //   scalarsList.Add( new pagesSetupData("BetAl_[0]",o_realbet)); // "Coefficient of isothermal compressibility b (or CN/dentateness for surface species)_
 //   scalarsList.Add( new pagesSetupData("BetAl_[1]",o_realbet,1)); //  Coefficient of isobaric expansibility a (or exponent parameter for surface species) "
    scalarsList.Add( new pagesSetupData("ab_[0]",o_reder)); // "Ion-size parameter ao  (Debye-Hueckel) or CD unit charge at zero plane for surface complexes_
    scalarsList.Add( new pagesSetupData("ab_[1]",o_reder,1)); // Individual parameter b (optional) (or unit charge at the beta plane for surface complexes) "
    // dynamic
   scalarsList.Add( new pagesSetupData("TCint_[0]",o_retcint)); // "Input interval of temperatures of the logK validity range; or vector of T values for logK interpolation "
   scalarsList.Add( new pagesSetupData("P_int[0]",o_repint));   // "Input interval of pressures of the logK validity range; or vector of P values for logK interpolation "
//   scalarsList.Add( new pagesSetupData("adCpT[0]",o_redcp));    // "Empirical coefficients of dCpr = f(T) equation: Free term coefficient a0_
//   scalarsList.Add( new pagesSetupData("adCpT[1]",o_redcp,1)); //  Coefficient a1 of the a1*T term of dCpr = f(T) equation_
//   scalarsList.Add( new pagesSetupData("adCpT[2]",o_redcp,2)); //  Coefficient a2  of the  a2*T^-2 term of dCpr = f(T) equation_
//   scalarsList.Add( new pagesSetupData("adCpT[3]",o_redcp,3)); //  Coefficient a3  of the  a3*T^-0.5 term of dCpr = f(T) equation_
//   scalarsList.Add( new pagesSetupData("adCpT[4]",o_redcp,4)); //  Coefficient a4  of the  a4*T^2 term of dCpr = f(T) equation_
   scalarsList.Add( new pagesSetupData("aiLgKr[0]",o_repkt,0)); // "a0 coefficient of logK = f(T) equation (or 1000*lnK = f(T) for an isotopic compound)_
   scalarsList.Add( new pagesSetupData("aiLgKr[1]",o_repkt,1)); //      a1 coefficient in the a1*T term of logK = f(T) equation (for isotopic species: in the a1/T term)_
   scalarsList.Add( new pagesSetupData("aiLgKr[2]",o_repkt,2)); //      a2 coefficient in the a2/T term of logK = f(T) equation (for isotopic species: in the a2/T^2 term)_
   scalarsList.Add( new pagesSetupData("aiLgKr[3]",o_repkt,3)); //      a3 coefficient in the a3*lnT term of logK = f(T) equation (for isotopic species: in the a3/T^3 term)_
   scalarsList.Add( new pagesSetupData("aiLgKr[4]",o_repkt,4)); //     a4 coefficient in the a4/T^2 term of logK = f(T) equation (for isotopic species: in the a4/T^4 term)_
   scalarsList.Add( new pagesSetupData("aiLgKr[5]",o_repkt,5)); //      a5 coefficient in the a5*T^2 term of logK = f(T) equation_
   scalarsList.Add( new pagesSetupData("aiLgKr[6]",o_repkt,6)); //      a6 coefficient in the a6/T^0.5 term of logK = f(T) equation_
    break;

 case RT_RTPARM:
//   scalarsList.Add( new pagesSetupData("rpPi[0]",o_rppi)); // "Pressure P, bar: start value of the pressure iterator_
//   scalarsList.Add( new pagesSetupData("rpPi[1]",o_rppi,1)); // Pressure P, bar: end value of the iterator_
//   scalarsList.Add( new pagesSetupData("rpPi[2]",o_rppi,2)); // ressure P, bar: step value of the iterator "
//   scalarsList.Add( new pagesSetupData("rpTi[0]",o_rpti)); //   o_rpti    rpTi   F_ 3 1    N "Temperature TC, centigrade: start value of the temperature iterator_
//   scalarsList.Add( new pagesSetupData("rpTi[1]",o_rpti,1)); //    Temperature TC, end value of the iterator_
//   scalarsList.Add( new pagesSetupData("rpTi[2]",o_rpti,2)); //    Temperature TC, step value of the iterator "

   scalarsList.Add( new pagesSetupData("xT",o_rpxt,-1)); //"T vector-column of temperature, usually an abscissa on the plots "
   scalarsList.Add( new pagesSetupData("xP",o_rpxp,-1)); //"P vector-column of pressures, optionally an abscissa on the plots "
//   scalarsList.Add( new pagesSetupData("yF",o_rpyf,-1)); // "RTParm table of sampled data "
//   scalarsList.Add( new pagesSetupData("xTE[0]",o_rpxte)); // "T vector (temperatures), abscissa on the plots for empirical data (optional) "
//   scalarsList.Add( new pagesSetupData("xPE[0]",o_rpxpe)); //"P vector (pressures), abscissa on the plots for empirical data (optional) "
//   scalarsList.Add( new pagesSetupData("ytE[0]",o_rpyte)); //"RTParm input table of empirical data (optional) "
...
//   scalarsList.Add( new pagesSetupData("fugVTP[1]",o_twfugv,1)); //  dVm of gas (reserved) "
  ...
  case RT_PHASE:
    scalarsList.Add( new pagesSetupData("DisPar[0]",o_phdisep,0)); //   "A  - phase specific surface area, m2/g_
    scalarsList.Add( new pagesSetupData("DisPar[1]",o_phdisep,1)); //     Sig0, specific surface free energy of phase-aqueous interface, J/m2_
    scalarsList.Add( new pagesSetupData("DisPar[2]",o_phdisep,2)); //     SigG, specific surface free energy of phase-gas interface, J/m2_
    scalarsList.Add( new pagesSetupData("DisPar[3]",o_phdisep,3)); //     Mean radius r0 for (spherical or cylindrical) particles, nm (reserved)_
    scalarsList.Add( new pagesSetupData("DisPar[4]",o_phdisep,4)); //     Mean thickness h0 for cylindrical or 0 for spherical particles, nm (reserved)_
    scalarsList.Add( new pagesSetupData("DisPar[5]",o_phdisep,5)); //     Dielectric constant for solid carrier at Tr (reserved)_
    scalarsList.Add( new pagesSetupData("DisPar[6]",o_phdisep,6)); //     Specific conductivity at Tr, Sm/m/cm2 (reserved)_
    scalarsList.Add( new pagesSetupData("DisPar[7]",o_phdisep,7)); //    Default maximum density for surface species, (12.05) 1/nm2 "
    // dynamic
...
scalarsList.Add( new pagesSetupData("iTm[0]",o_petmi,0)); // "SysEq CSD variant number: start value_
scalarsList.Add( new pagesSetupData("iTm[1]",o_petmi,1)); // SysEq CSD variant number: end value_
scalarsList.Add( new pagesSetupData("iTm[2]",o_petmi,2)); // SysEq CSD variant number: step value "
scalarsList.Add( new pagesSetupData("cTm",o_pec_tm));     //"Current SysEq CSD variant number "
scalarsList.Add( new pagesSetupData("iV[0]",o_pevi,0)); // "Volume constraint of the system (L): start value_
scalarsList.Add( new pagesSetupData("iV[1]",o_pevi,1)); // Volume constraint of the  system:  end value_
scalarsList.Add( new pagesSetupData("iV[2]",o_pevi,2)); // Volume constraint of the system: increment "
scalarsList.Add( new pagesSetupData("cV",o_pec_v)); //"Current V - volume constraint (default: 0) "
scalarsList.Add( new pagesSetupData("iP[0]",o_pepi,0)); // "Pressure of interest P, bar: start (real) value_
scalarsList.Add( new pagesSetupData("iP[1]",o_pepi,1)); // Pressure of interest P, bar: end value_
scalarsList.Add( new pagesSetupData("iP[2]",o_pepi,2)); // Pressure of interest P, bar: step value "
scalarsList.Add( new pagesSetupData("cP",o_pec_p)); //"Current pressure of interest P (bar) "
scalarsList.Add( new pagesSetupData("iTC[0]",o_peti,0)); //"Temperature of interest TC, centigrade: start value_
scalarsList.Add( new pagesSetupData("iTC[1]",o_peti,1)); // Temperature of interest TC, centigrade: end value_
scalarsList.Add( new pagesSetupData("iTC[2]",o_peti,2)); // Temperature of interest TC, centigrade: step value "
scalarsList.Add( new pagesSetupData("cTC",o_pec_tc)); // "Current temperature of interest TC (centigrade) "
scalarsList.Add( new pagesSetupData("cT",o_pec_t)); //"Current temperature of interest T (Kelvin) "
scalarsList.Add( new pagesSetupData("iNv[0]",o_penvi,0)); //"TD variant number: start value_
scalarsList.Add( new pagesSetupData("iNv[1]",o_penvi,1)); // TD variant number: end value_
scalarsList.Add( new pagesSetupData("iNv[2]",o_penvi,2)); // TD variant number: step value "
scalarsList.Add( new pagesSetupData("cNV",o_pec_nv)); //"Current SysEq TD variant number "
scalarsList.Add( new pagesSetupData("iTau[0]",o_petaui,0)); //"Real time (tau), arbitrary units: start value_
scalarsList.Add( new pagesSetupData("iTau[1]",o_petaui,1)); // Real time (tau): end value_
scalarsList.Add( new pagesSetupData("iTau[2]",o_petaui,2)); // Real time (tau): step value "
scalarsList.Add( new pagesSetupData("cTau",o_pec_tau)); //"Current real time (tau) "
scalarsList.Add( new pagesSetupData("ipXi[0]",o_pepxii,0)); //N "Process extent parameter pXi = -log(Xi): start value_
scalarsList.Add( new pagesSetupData("ipXi[1]",o_pepxii,1)); // Process extent parameter pXi: end value (precision for inverse titrations)_
scalarsList.Add( new pagesSetupData("ipXi[2]",o_pepxii,2)); // Process extent parameter pXi: step value "
scalarsList.Add( new pagesSetupData("cpXi",o_pec_pxi)); //"Current pXi = -log(Xi), where Xi stands for a logarithmic reaction extent variable "
scalarsList.Add( new pagesSetupData("cXi",o_pec_xi)); //"Current Xi = 10^cpXi - the linear process extent variable "
scalarsList.Add( new pagesSetupData("iNu[0]",o_penui,0)); //"Factor of the process extent Nu: start value_
scalarsList.Add( new pagesSetupData("iNu[1]",o_penui,1)); // Factor of the process extent Nu: end value_
scalarsList.Add( new pagesSetupData("iNu[2]",o_penui,2)); // Factor of the process extent Nu: step value "
scalarsList.Add( new pagesSetupData("cNu",o_pec_nu)); //"Current Nu - the process extent factor "
scalarsList.Add( new pagesSetupData("ipH[0]",o_pephi,0)); //"Prescribed pH sequence (for inverse titrations): start value_
scalarsList.Add( new pagesSetupData("ipH[1]",o_pephi,1)); // Prescribed pH sequence: end value_
scalarsList.Add( new pagesSetupData("ipH[2]",o_pephi,2)); // Prescribed pH sequence: step size "
scalarsList.Add( new pagesSetupData("cpH",o_pec_ph)); //"Current pH at J-th inverse titration point "
scalarsList.Add( new pagesSetupData("ipe[0]",o_pepei,0)); //o_pepei   ipe    D_ 3 1    N "Prescribed pe values for inverse titration sequence: start value_
scalarsList.Add( new pagesSetupData("ipe[1]",o_pepei,1)); // Prescribed pe values: end value_
scalarsList.Add( new pagesSetupData("ipe[2]",o_pepei,2)); // Prescribed pe sequence: step size "
scalarsList.Add( new pagesSetupData("cpe",o_pec_pe)); //"Current pe at J-th inverse titration point "
scalarsList.Add( new pagesSetupData("cEh",o_pec_eh)); //"Current Eh value (aqueous systems only) "
...
scalarsList.Add( new pagesSetupData("Next",o_penext)); //"A flag to continue (1) or finish (0) main process simulation steps "
scalarsList.Add( new pagesSetupData("I",o_pei)); //"Internal index in an inverse titration sequence step "
scalarsList.Add( new pagesSetupData("J",o_pej)); //"Process simulation main step index "
scalarsList.Add( new pagesSetupData("Jp",o_pec_nrk)); //"Current index of the processed SysEq in the record key list "

//# Optional storage vectors for the process simulator
scalarsList.Add( new pagesSetupData("vTm",o_petmv,-1)); //"Optional vector to collect VarCSD ( cTm ) numbers from main process simulaion steps "
scalarsList.Add( new pagesSetupData("vNV",o_penvv,-1)); //"Optional vector of VarTD (cNV) numbers from main process simulation steps "
scalarsList.Add( new pagesSetupData("vP",o_pepv,-1)); //"Optional vector of pressure values (cP) from main process simulation steps "
scalarsList.Add( new pagesSetupData("vV",o_pevv,-1)); //"Optional vector of volume constraint (cV) values from main process simulation steps "
scalarsList.Add( new pagesSetupData("vT",o_petv,-1)); //"Optional vector of temperatures (cT) from main process simulation steps "
scalarsList.Add( new pagesSetupData("vTau",o_petauv,-1)); //"Optional vector of Tau (physical time, cTau) values from main process simulation steps "
scalarsList.Add( new pagesSetupData("vpXi",o_pepxiv,-1)); //"Optional vector of pXi (-log process extent cpXi) values from main process simulation steps "
scalarsList.Add( new pagesSetupData("vNu",o_penuv,-1)); //"Optional vector of Nu (process extent factor cNu) values from main process simulation steps "
scalarsList.Add( new pagesSetupData("vKin[0]",o_pekinv)); //"Optional array of parameters for (reaction) kinetic dependencies "
scalarsList.Add( new pagesSetupData("modC",o_pemodc,-1)); //"Array of the process simulation parameters "
scalarsList.Add( new pagesSetupData("xp",o_pcx0,-1)); //"Vector-column of abscissa x "
scalarsList.Add( new pagesSetupData("yp",o_pcy0,-1)); //"Data table of ordinate(s) y "
scalarsList.Add( new pagesSetupData("xEp[0]",o_pcxe)); //"Vector-column of abscissa for empirical data xE "
scalarsList.Add( new pagesSetupData("yEp[0]",o_pcye)); //"Vector-column (or table) of ordinate(s) for empirical data yE "
    break;

  case RT_GTDEMO:
//# GTDEMO work DOD
scalarsList.Add( new pagesSetupData("jR",o_gwjr)); //"Index of currently sampled database record "
scalarsList.Add( new pagesSetupData("next",o_gwnext)); //"A flag to continue (1) or finish (0) the data sampling steps "
...
// dynamic
scalarsList.Add( new pagesSetupData("xE[0]",o_gdxe,0)); //"Vector-column of abscissa for empirical data "
scalarsList.Add( new pagesSetupData("yE[0]",o_gdye,0)); //"Vector-column (or table) of ordinate(s) for empirical data "
...
//    break;
 ...
 //# GEMS2MT work DOD
 //scalarsList.Add( new pagesSetupData("_ctm",o_mtctm)); //current CSD #"
 //o_mtcnv    cnv   I_ 1 1    N "current restriction variant #"
 scalarsList.Add( new pagesSetupData("qc",o_mtqc)); // current index of the compartment ( 1 to nC )"
 ...
 scalarsList.Add( new pagesSetupData("jt",o_mtjt));//index of sampled point (for sampling scripts)"
 ...
 scalarsList.Add( new pagesSetupData("ct",o_mtct_));// actual time iterator"
 ...
 scalarsList.Add( new pagesSetupData("cTaut",o_mtctau));// current physical time"
 scalarsList.Add( new pagesSetupData("dTau",o_mtdtau)); // current time step value"
...
//scalarsList.Add( new pagesSetupData("mInput[0]",o_mtdoudl,0));//   Masses (kg) and volumes (L) for initial systems: Ms (total mass, normalize)_
//scalarsList.Add( new pagesSetupData("mInput[1]",o_mtdoudl,1));//   Vs (total volume of the object, for volume concentrations)_
//scalarsList.Add( new pagesSetupData("mInput[2]",o_mtdoudl,2));//   M(H2O) (mass of water-solvent for molalities)_
//scalarsList.Add( new pagesSetupData("mInput[3]",o_mtdoudl,3));//   Maq (mass of aqueous solution for ppm etc.)_
//scalarsList.Add( new pagesSetupData("mInput[4]",o_mtdoudl,4));//   Vaq (volume of aqueous solution for molarities)_
//scalarsList.Add( new pagesSetupData("mInput[5]",o_mtdoudl,5));//   Pg (pressure in gas, for partial pressures)_
//scalarsList.Add( new pagesSetupData("mInput[6]",o_mtdoudl,6));//   MOL total mole amount for basis sub-system composition calculations_
//scalarsList.Add( new pagesSetupData("mInput[7]",o_mtdoudl,7));//   mole fraction of the carrier DC (e.g. sorbent or solvent)_
//scalarsList.Add( new pagesSetupData("mInput[8]",o_mtdoudl,8));//   Specific surface area of the sorbent (for adsorbed species)"
//scalarsList.Add( new pagesSetupData("ADpar[0]",o_mtadpar,0));// o_mtadpar ADpar D_  1 11  N "Advection/diffusion mass transport:fluid advection velocity (m/sec)_
//scalarsList.Add( new pagesSetupData("ADpar[1]",o_mtadpar,1));//   column length (m)_
//scalarsList.Add( new pagesSetupData("ADpar[2]",o_mtadpar,2));//  time step reduction factor_
//scalarsList.Add( new pagesSetupData("ADpar[3]",o_mtadpar,3));//   cutoff factor for differences_
//scalarsList.Add( new pagesSetupData("ADpar[4]",o_mtadpar,4));//  cutoff factor for minimal amounts of IC in node bulk compositions_
//scalarsList.Add( new pagesSetupData("ADpar[5]",o_mtadpar,5));//   ADrs1,  reserved_
//scalarsList.Add( new pagesSetupData("ADpar[6]",o_mtadpar,6));//   ADrs2,  reserved_
//scalarsList.Add( new pagesSetupData("ADpar[7]",o_mtadpar,7));//   ADrs3,  reserved_
//scalarsList.Add( new pagesSetupData("ADpar[8]",o_mtadpar,8));//   ADrs4,  reserved_
//scalarsList.Add( new pagesSetupData("ADpar[9]",o_mtadpar,9));//   ADrs5,  reserved_
//scalarsList.Add( new pagesSetupData("ADpar[10]",o_mtadpar,10));//   ADrs6   reserved"
scalarsList.Add( new pagesSetupData("qpc[0]",o_mtqpc)); // Work array for mass transport math script"
scalarsList.Add( new pagesSetupData("HydP[qc][0]", o_mthydp,0));// | Initial hydraulic parameters in nodes: Vt - total volume of node = dx*dy*dz, m**3_
scalarsList.Add( new pagesSetupData("HydP[qc][1]", o_mthydp,1));//| vp - advection velocity (in pores) in this node (m/sec)_
scalarsList.Add( new pagesSetupData("HydP[qc][2]", o_mthydp,2));//| eps - effective (actual) porosity (0 < eps < 1)_
scalarsList.Add( new pagesSetupData("HydP[qc][3]", o_mthydp,3));//| Km - effective (actual) actual permeability, m**2_
scalarsList.Add( new pagesSetupData("HydP[qc][4]", o_mthydp,4));//| al - specific longitudinal dispersivity of porous medium, m_
scalarsList.Add( new pagesSetupData("HydP[qc][5]", o_mthydp,5));//| Dif - general diffusivity of disolved matter in the mode_
scalarsList.Add( new pagesSetupData("HydP[qc][6]", o_mthydp,6));//| nto - tortuosity factor"
...
//wnData.Add( new pagesSetupData("xIC", o_ch_xic));//ICNL indices in DATABR IC vectors [nICb]"
//wnData.Add( new pagesSetupData("xDC", o_ch_xdc));//DCNL indices in DATABR DC list [nDCb]"
//wnData.Add( new pagesSetupData("xPH", o_ch_xph));//PHNL indices in DATABR phase vectors [nPHb]"
//wnData.Add( new pagesSetupData("Amat", o_ch_a));//DC stoichiometry matrix A composed of a_ij [nIC][nDC]"
wnData.Add( new pagesSetupData("ICmm", o_ch_icmm));//IC atomic (molar) mass, g/mole [nIC]"
wnData.Add( new pagesSetupData("DCmm", o_ch_dcmm));//DC molar mass, g/mole [nDC]"
...
//# Data Bridge access DOD list
      wnData.Add( new pagesSetupData("n1bIC", o_n1_bic));//bulk mole amounts of IC[nICb] in node 1 + + - -"
      wnData.Add( new pagesSetupData("n1uIC", o_n1_uic));//IC chemical potentials (mol/mol)[nICb]  - - + +"
      wnData.Add( new pagesSetupData("n1xDC", o_n1_xdc));//DC mole amounts at equilibrium in node 1 [nDCb] - - + +"
      wnData.Add( new pagesSetupData("n1gam", o_n1_gam));//activity coeffs of DC [nDCb] in node 1 - - + +"
      wnData.Add( new pagesSetupData("n1xPH", o_n1_xph));//total mole amounts of phases [nPHb] in node 1 - - + +"
      wnData.Add( new pagesSetupData("n1mPS", o_n1_mps));//phase mass, g [nPSb] in node 1 - - + +"
      wnData.Add( new pagesSetupData("n1vPS", o_n1_vps));//phase volume, cm3 [nPSb] in node 1 - - + +"
      wnData.Add( new pagesSetupData("n1xPA", o_n1_xpa));//amount of carrier in phases  [nPSb] ?? in node 1 - - + +"
      wnData.Add( new pagesSetupData("n1bSP", o_n1_bsp));//Bulk composition of all solids  [nICb] in node 1 - - + +"
      wnData.Add( new pagesSetupData("n1aPH", o_n1_aph));// Specific surface areas of phases (m2/kg) in node 1 + + - -"
...
wnData.Add( new pagesSetupData("n1m_t", o_n1w_m_t));//total dissolved molality of independent components, m [nICb] in node 1 + + - -"
wnData.Add( new pagesSetupData("n1con", o_n1w_con));//DC concentrations in phases (molal, mole fraction) [nDCb] in node 1 + + - -"
wnData.Add( new pagesSetupData("n1mju", o_n1w_mju));//DC chemical potentials in equilibrium, J/mol [nDCb] in node 1 + + - -"
wnData.Add( new pagesSetupData("n1lga", o_n1w_lga));//DC activities in equilibrium, in log10 scale [nDCb] in node 1 + + - -"
...
scalarsList.Add( new pagesSetupData("n1ct[0]",o_n1_ct,0)); //Node 1 controls
scalarsList.Add( new pagesSetupData("n1ct[1]",o_n1_ct,1));
scalarsList.Add( new pagesSetupData("n1ct[2]",o_n1_ct,2));
scalarsList.Add( new pagesSetupData("n1ct[3]",o_n1_ct,3));
scalarsList.Add( new pagesSetupData("n1ct[4]",o_n1_ct,4));
scalarsList.Add( new pagesSetupData("n1ct[5]",o_n1_ct,5));

scalarsList.Add( new pagesSetupData("n1cs[0]",o_n1_cs,0)); // Node 1 scalar chemical variables
scalarsList.Add( new pagesSetupData("n1cs[1]",o_n1_cs,1));
scalarsList.Add( new pagesSetupData("n1cs[2]",o_n1_cs,2));
scalarsList.Add( new pagesSetupData("n1cs[3]",o_n1_cs,3));
scalarsList.Add( new pagesSetupData("n1cs[4]",o_n1_cs,4));
scalarsList.Add( new pagesSetupData("n1cs[5]",o_n1_cs,5));
scalarsList.Add( new pagesSetupData("n1cs[6]",o_n1_cs,6));
scalarsList.Add( new pagesSetupData("n1cs[7]",o_n1_cs,7));
scalarsList.Add( new pagesSetupData("n1cs[8]",o_n1_cs,8));
scalarsList.Add( new pagesSetupData("n1cs[9]",o_n1_cs,9));
scalarsList.Add( new pagesSetupData("n1cs[10]",o_n1_cs,10));
scalarsList.Add( new pagesSetupData("n1cs[11]",o_n1_cs,11));
scalarsList.Add( new pagesSetupData("n1cs[12]",o_n1_cs,12));

scalarsList.Add( new pagesSetupData("n1ts[0]",o_n1_ts,0)); // Node 1 scalar transport variables
scalarsList.Add( new pagesSetupData("n1ts[1]",o_n1_ts,1));
scalarsList.Add( new pagesSetupData("n1ts[2]",o_n1_ts,2));
scalarsList.Add( new pagesSetupData("n1ts[3]",o_n1_ts,3));
scalarsList.Add( new pagesSetupData("n1ts[4]",o_n1_ts,4));
scalarsList.Add( new pagesSetupData("n1ts[5]",o_n1_ts,5));
scalarsList.Add( new pagesSetupData("n1ts[6]",o_n1_ts,6));
scalarsList.Add( new pagesSetupData("n1ts[7]",o_n1_ts,7));
scalarsList.Add( new pagesSetupData("n1ts[8]",o_n1_ts,8));
scalarsList.Add( new pagesSetupData("n1ts[9]",o_n1_ts,9));
scalarsList.Add( new pagesSetupData("n1ts[10]",o_n1_ts,10));
scalarsList.Add( new pagesSetupData("n1ts[11]",o_n1_ts,11));
scalarsList.Add( new pagesSetupData("n1ts[12]",o_n1_ts,12));
scalarsList.Add( new pagesSetupData("n1ts[13]",o_n1_ts,13));
scalarsList.Add( new pagesSetupData("n1ts[14]",o_n1_ts,14));
scalarsList.Add( new pagesSetupData("n1ts[15]",o_n1_ts,15));
scalarsList.Add( new pagesSetupData("n1ts[16]",o_n1_ts,16));
scalarsList.Add( new pagesSetupData("n1ts[17]",o_n1_ts,17));
scalarsList.Add( new pagesSetupData("n1ts[18]",o_n1_ts,18));
...
wnData.Add( new pagesSetupData("Vale_", o_muval)); //I "Vector of default valencies of IC "
wnData.Add( new pagesSetupData("M0ic",  o_mubc)); //I "Vector of IC atomic (molar) masses, g/mol "
...
scalarsList.Add( new pagesSetupData("T",o_tp_T)); //"Current temperature of interest (T) in C"
scalarsList.Add( new pagesSetupData("P",o_tp_P)); //"Current pressure of interest (P) "
scalarsList.Add( new pagesSetupData("RTf[0]",o_tp_RT,0)); //"Current RT factor (J/mol)_
scalarsList.Add( new pagesSetupData("RTf[1]",o_tp_RT,1)); // T of interest in Kelvins "
scalarsList.Add( new pagesSetupData("RoW[0][0]",o_tprow,0)); //"Current densities of liquid water and steam (in g/cm3) "
scalarsList.Add( new pagesSetupData("EpsW[0][0]",o_tpepsw,0)); // "Current dielectric constants of liquid water and steam "
scalarsList.Add( new pagesSetupData("VisW[0]",o_tpvisw,0)); //"Current dynamic viscosities of liquid water and steam (in kg/m*sec) "
...
wnData.Add( new pagesSetupData("gTP", o_tpg)); //"Molar (molal) standard Gibbs energy functions of Dependent Components at T,P of interest "
//o_tpdevg  gTPuns D_  -2 1  J "Uncertainties of gTP values (reserved for future versions) "
wnData.Add( new pagesSetupData("hTP", o_tph)); //"Molar (molal) standard enthalpy functions of Dependent Components at T,P of interest "
//o_tpdevh  hTPuns D_  -2 1  J "Uncertainties of hTP values (reserved for future versions) "
wnData.Add( new pagesSetupData("STP", o_tps)); //"Molar (molal) entropies of Dependent Components at T,P of interest "
//o_tpdevs  STPuns D_  -2 1  J "Uncertainties of STP values (reserved for future versions) "
wnData.Add( new pagesSetupData("CpTP", o_tpcp)); //"Molar (molal) standard entropies of Dependent Components at T, P of interest "
//o_tpdevcp CTPuns D_  -2 1  J "Uncertainties of CpTP values (reserved for future versions) "
wnData.Add( new pagesSetupData("VTP", o_tpvm)); //"Molar (molal) volumes of Dependent Components at T,P of interest "
...
//# SYSTEM Definition DOD (I J A K indexation)
    scalarsList.Add( new pagesSetupData("Masses[0]",o_symass,0)); //"Molality of reference electrolyte. Reserved for future use_
    scalarsList.Add( new pagesSetupData("Masses[1]",o_symass,1)); // Anticipated mass (kg) of water-solvent (Mwat)_
    scalarsList.Add( new pagesSetupData("Masses[2]",o_symass,2)); // Anticipated total mass of the system Msys (kg)_
    scalarsList.Add( new pagesSetupData("Masses[3]",o_symass,3)); // Anticipated mass of aqueous phase Maq (kg)_
    scalarsList.Add( new pagesSetupData("Masses[4]",o_symass,4)); // Final total mass of the system MBX (kg)_
    scalarsList.Add( new pagesSetupData("Masses[5]",o_symass,5)); // Total number of IC moles in the system NMS  (for mole %% calculations) "
    scalarsList.Add( new pagesSetupData("Volums[0]",o_syvol,0)); //"Anticipated volume Vsys of the system (L)_
    scalarsList.Add( new pagesSetupData("Volums[1]",o_syvol,1)); // Anticipated volume Vaq  of aqueous phase (L) for molarities "
scalarsList.Add( new pagesSetupData("N_",o_syn)); //"N, Number of Independent Components included into CSD "
scalarsList.Add( new pagesSetupData("L_[0]",o_syl,0)); //"L, Number of Dependent Components included into CSD_
scalarsList.Add( new pagesSetupData("L_[1]",o_syl,1)); // Number of Dependent Components included into  multicomponent phases (Ls)_
scalarsList.Add( new pagesSetupData("L_[2]",o_syl,2)); // Number of species selected into the aqueous phase (Lw, including solvent)_
scalarsList.Add( new pagesSetupData("L_[3]",o_syl,3)); // Number of species selected into sorption phase(s) (Lads)_
scalarsList.Add( new pagesSetupData("L_[4]",o_syl,4)); // Number of species selected into gas phase (Lg)_
scalarsList.Add( new pagesSetupData("L_[5]",o_syl,5)); // Number of species selected into the liquid hydrocarbon phase (Lhc, reserved) "
scalarsList.Add( new pagesSetupData("Fi_[0]",o_syfi,0)); //"Number of phases taken into this CSD (Fi)_
scalarsList.Add( new pagesSetupData("Fi_[1]",o_syfi,1)); // Number of multi-component phases in this CSD (Fis)_
scalarsList.Add( new pagesSetupData("Fi_[2]",o_syfi,2)); // Number of phases used in non-zero quantities in BCC calculation (sequential reactors mode only)_
scalarsList.Add( new pagesSetupData("Fi_[3]",o_syfi,3)); // Number of phases with kinetic/metastability restrictions (reserved) "
...
wnData.Add( new pagesSetupData("xa_", o_syxea)); // K "Input quantities or concentrations of PCO contributing to B_ vector "
wnData.Add( new pagesSetupData("bi_", o_sybi)); // I "Input quantities or concentrations of Independent Components contributing to B_ vector "
wnData.Add( new pagesSetupData("B_", o_syb)); //"Input bulk composition of the system (moles of IC) obtained from BCC calculation "
//o_sydelb  B_uns  F_  -3 1  I "Uncertainties of the bulk composition vector B_  elements (moles) "
wnData.Add( new pagesSetupData("xd_", o_syxed)); // J "Input quantities or concentrations of Dependent Components contributing to B_ vector "
wnData.Add( new pagesSetupData("dul_", o_sydul)); // J "Upper metastability restrictions for DC mole quantities x at equilibrium state "
...
wnData.Add( new pagesSetupData("Nfsp_", o_synfsp)); // A "Fractions of sorbent surface allocated to surface types "
//o_symasdt MaSdt_ F_  -3 3  A "Total maximum site density for surface types, 1/nm2 (for competitive SAT) "
wnData.Add( new pagesSetupData("XcapA_", o_syxcapa)); //A "Inner capacitance density parameter C1 (TLM,BSM,CCM) for surface types, F/m2 "
wnData.Add( new pagesSetupData("XcapB_", o_syxcapb)); // A "Outer capacitance density parameter C2 (TLM) for surface types, F/m2 "
wnData.Add( new pagesSetupData("XfIEC_", o_syxfiec)); // A "Density of permanent surface charge (mkeq/m2) "
wnData.Add( new pagesSetupData("XcapF_", o_syxcapf)); // A "Anionic outer-sphere capacitance density parameter C3 (F/m2), reserved "
wnData.Add( new pagesSetupData("Xlam_", o_syxlam)); // A "FFG parameter for surface types, >0, <1 (reserved) "
wnData.Add( new pagesSetupData("MaSdj_[][0]", o_symasdj,0)); //S "| Parameters for surface activity correction terms: Surface (site) complete coverage density (1/nm2)_
wnData.Add( new pagesSetupData("MaSdj_[][1]", o_symasdj,1)); //| Formula unit charge assigned to 0 surface EDL plane_
wnData.Add( new pagesSetupData("MaSdj_[][2]", o_symasdj,2)); //| Formula unit charge assigned to beta EDL surface plane_
wnData.Add( new pagesSetupData("MaSdj_[][3]", o_symasdj,3)); //| Isotherm parameter 1 (interaction parameter in Frumkin isotherm)_
wnData.Add( new pagesSetupData("MaSdj_[][4]", o_symasdj,4)); //| Isotherm parameter 2 (dentateness in QCA isotherms)_
wnData.Add( new pagesSetupData("MaSdj_[][5]", o_symasdj,5)); //| Isotherm parameter 3 (reserved for other isotherms) "
wnData.Add( new pagesSetupData("Sigm_[][0]", o_sysigm,0)); // A "| Specific surface energy of phase-aqueous interface, J/m2_
wnData.Add( new pagesSetupData("Sigm_[][1]", o_sysigm,1)); //| Specific surface energy of phase-gas interface, J/m2 (not used yet)"
...
//# Modelling Project IPM MULTI DOD (i j a indexation and basis)
    ...
    scalarsList.Add( new pagesSetupData("TK[1]",o_wio_t,1));
    scalarsList.Add( new pagesSetupData("PG[0]",o_wio_p)); //"General pressure P (bars), min.-max. for parametric problems "
    scalarsList.Add( new pagesSetupData("PG[1]",o_wio_p,1));
    scalarsList.Add( new pagesSetupData("Vx[0]",o_wo_vx)); //"Initial V and calculated V(x) volume of the system (cm3) "
    scalarsList.Add( new pagesSetupData("Vx[1]",o_wo_vx,1));
...
scalarsList.Add( new pagesSetupData("_nnr[0]",o_wi_nnr,0)); //"Number of Independent Components in the IPM problem n(N)_
scalarsList.Add( new pagesSetupData("_nnr[1]",o_wi_nnr,1)); // NR - dimensions of the R matrix"
scalarsList.Add( new pagesSetupData("L[0]",o_wi_ldim,0)); //"Number of Dependent Components in the IPM problem n(L)_
scalarsList.Add( new pagesSetupData("L[1]",o_wi_ldim,1)); // Number of Dependent Components included into  multicomponent phases n(Ls)_
scalarsList.Add( new pagesSetupData("L[2]",o_wi_ldim,2)); // Index of water-solvent LO, equals number of aqueous species n(Laq)_
scalarsList.Add( new pagesSetupData("L[3]",o_wi_ldim,3)); // Number of Dependent Components included in the gas phase PG = n(Lg)_
scalarsList.Add( new pagesSetupData("L[4]",o_wi_ldim,4)); // Number of Dependent Components in the liquid hydrocarbon phase PSOL (reserved)_
scalarsList.Add( new pagesSetupData("L[5]",o_wi_ldim,5)); // Number of Dependent Components included in sorption phases n(Lads) "
scalarsList.Add( new pagesSetupData("Fi[0]",o_wi_fdim,0)); //"Number of Phases included in the IPM problem n(Fi)_
scalarsList.Add( new pagesSetupData("Fi[1]",o_wi_fdim,1)); // Number of multi-component phases n(Fis)_
scalarsList.Add( new pagesSetupData("Fi[2]",o_wi_fdim,2)); // Number of sorption multi-component phases n(Fia) "
scalarsList.Add( new pagesSetupData("FI[0]",o_wo_fdim,0)); //"Number of phases present in non-zero quantities at equilibrium state_
scalarsList.Add( new pagesSetupData("FI[1]",o_wo_fdim,1)); // Number of multi-component phases present in non-zero quantities at equilibrium state_
...
scalarsList.Add( new pagesSetupData("denW[0][0]",o_wio_denw,0)); //"Density of H2O(l)_
scalarsList.Add( new pagesSetupData("denW[1][0]",o_wio_denw,1)); // Density of steam  at T,P of interest "
scalarsList.Add( new pagesSetupData("epsW[0][0]",o_wio_epsw,0)); //"Dielectric constant of H2O(l)_
scalarsList.Add( new pagesSetupData("epsW[1][0]",o_wio_epsw,1)); // Dielectric constant of steam  for T,P of interest "
...
wnData.Add( new pagesSetupData("u", o_wo_u)); //i "Chemical potentials of Independent Components at equilibrium state (mol/mol) "
wnData.Add( new pagesSetupData("ue", o_wd_ur)); // i "Chemical potentials of Independent Components at equilibrium state (J/mol) "
//o_wd_uc   uc     D_  -3 1  i  "Copy of Chemical potentials of Independent Components at equilibrium state (mol/mol) "
wnData.Add( new pagesSetupData("b", o_wi_b)); // i "Input bulk composition of the system (moles of Independent Components) "
wnData.Add( new pagesSetupData("Cb", o_wo_c)); // i "Mass balance residuals for Independent Components (at IPM convergence) "
wnData.Add( new pagesSetupData("m_t", o_wd_icm)); //i "Output total dissolved molalities of Independent Components at equilibrium state "
wnData.Add( new pagesSetupData("lgm_t", o_wd_iclcm)); // i "Decimal logarithms of total dissolved molalities of Independent Components at equilibrium state "
// wnData.Add( new pagesSetupData("w_t", o_wd_icwm)); //i "Output total dissolved mass concentrations of Independent Components at equilibrium state "
wnData.Add( new pagesSetupData("icM", o_wi_awt)); //i "Input  atomic (molar) masses of Independent Components, g/mol "

// primary output for Phases
wnData.Add( new pagesSetupData("Xa", o_w_xf)); //a "Output total mole quantities of phases "
//o_wo_yf   Xao    D_  -3 1  a "Work copy of the Xa  vector from previous IPM iteration "
wnData.Add( new pagesSetupData("Xwa", o_ww_xfa)); // a "Output mole quantities of the solvent (sorbent) in multi-component phases "
//o_ww_yfa  Xwao   D_  -3 1  a "Work copy of  the Xwa  vector from previous IPM iteration "
wnData.Add( new pagesSetupData("phVol", o_wd_fvol)); // a "Volumes of phases (in cm3) "
wnData.Add( new pagesSetupData("phM", o_wd_fwgt)); //a "Masses of phases (in grams) "
wnData.Add( new pagesSetupData("Fa", o_wo_falp)); //a "Values of the phase stability criterion f(alpha) "
...
wnData.Add( new pagesSetupData("Sigw", o_wi_sigw)); //a "Specific surface energy of phase - aqueous interface, J/m2 "
...
wnData.Add( new pagesSetupData("x", o_w_x)); //j "Output mole quantities of Dependent Components (species) at equilibrium state (primal solution) "
...
wnData.Add( new pagesSetupData("Wxx", o_wo_wx)); // j "Mole fractions of Dependent Components in multi-component phases "
wnData.Add( new pagesSetupData("my", o_wd_ym)); // j "Molality concentrations of Dependent Components (in mol per kg H2O) "
wnData.Add( new pagesSetupData("v", o_wo_f)); // j "Primal chemical potentials of Dependent Components (in mol/mol) "
wnData.Add( new pagesSetupData("vEx", o_w_f0)); // j "Excess molar Gibbs energy of Dependent Components, mol/mol "
wnData.Add( new pagesSetupData("lga", o_wd_yla)); // j "Log10 of general activity (fugacity) of Dependent Components at equilibrium state "
// wnData.Add( new pagesSetupData("wy", o_wd_yw)); // j "Mass concentrations of DC in multi-component phases, % (ppm in aqueous phase) "
wnData.Add( new pagesSetupData("gamma", o_wd_gamma)); // j "Activity coefficients of DCs (external) in practical scale (molal for aqueous species) "
wnData.Add( new pagesSetupData("lnGam", o_wo_lngam)); // j "Calculated  ln of internal (rational) DC activity coefficients in all phases "
...
wnData.Add( new pagesSetupData("dul", o_wi_dul)); //"Upper metastability restrictions for DC mole quantities x at equilibrium state "
...
wnData.Add( new pagesSetupData("A", o_wi_a)); //c "Input stoichiometry matrix of Dependent Components "

// Adsorption
wnData.Add( new pagesSetupData("nfsp", o_wi_nfsp)); // a "Fractions of sorbent surface allocated to surface types "
//o_wi_masdt masdt D_  -3 6  a "Total maximum site density for surface types, mkmol/g (for competitive SAT) "
wnData.Add( new pagesSetupData("capA", o_w_xcapa)); //a "Inner capacitance density parameter C1 (TLM,BSM,CCM) for surface types, F/m2 "
wnData.Add( new pagesSetupData("capB", o_w_xcapb)); // a "Outer capacitance density parameter C2 (TLM) for surface types, F/m2, or C_an (BSM) "
//o_w_xcapd capD   D_  -3 6  a "Capacitance density (reserved)"
wnData.Add( new pagesSetupData("capF", o_w_xcapf)); // a "Capacitance density of anionic EDL layer in FLM or CD-MUSIC, F/m2 (reserved) "
...
wnData.Add( new pagesSetupData("psiA", o_wo_psia)); // a "Relative electrostatic potential on zero EDL plane (sorbent surface), V "
wnData.Add( new pagesSetupData("psiB", o_wo_psib)); // a "Relative electrostatic potential on beta EDL plane (outer-sphere), V "
wnData.Add( new pagesSetupData("psiD", o_wo_psid)); // a "Reserved "
...
wnData.Add( new pagesSetupData("etaF", o_wi_xetaf)); // a "Density of permanent surface charge, C/m2 "
...
wnData.Add( new pagesSetupData("masdj[][0]", o_wo_masdj)); //s "| Parameters of surface species for calculation of activity correction terms: Max. density (umol/g)_
wnData.Add( new pagesSetupData("masdj[][1]", o_wo_masdj,1)); //| Species charge assigned to 0 EDL surface plane_
wnData.Add( new pagesSetupData("masdj[][2]", o_wo_masdj,2)); //| Species charge assigned to beta EDL surface plane_
wnData.Add( new pagesSetupData("masdj[][3]", o_wo_masdj,3)); //| Isotherm parameter 1 (Frumkin energy)_
wnData.Add( new pagesSetupData("masdj[][4]", o_wo_masdj,4)); //| Isotherm parameter 2 (Frumkin CN or dentateness )_
wnData.Add( new pagesSetupData("masdj[][5]", o_wo_masdj,5)); //| Isotherm parameter 3 (reserved ) "
...
wnData.Add( new pagesSetupData("etaA", o_w_xetaa)); //a "Total surface charge on 0 EDL plane (sorbent surface), moles "
wnData.Add( new pagesSetupData("etaB", o_w_xetab)); // a "Total surface charge on 1 (beta) EDL plane (CD, outer-sphere), moles "
wnData.Add( new pagesSetupData("etaD", o_w_xetad)); //a "Total surface charge on 2 (d) EDL plane (CD, outer-sphere), moles "
wnData.Add( new pagesSetupData("Xfts", o_w_xfts)); // a "Total number of moles of surface species at surface type "
