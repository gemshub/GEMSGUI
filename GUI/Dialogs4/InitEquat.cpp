...
//# Modelling Project IPM MULTI DOD (i j a indexation and basis)
    scalarsList.push_back(  pagesSetupData("Mbx",o_wi_mbx)); //"Total mass of the whole system, kg "
    scalarsList.push_back(  pagesSetupData("pmXs", o_wio_pmxs)); // "Total mass of all solid phases in the system (g), obtained from bXs vector "
    scalarsList.push_back(  pagesSetupData("GX",o_wo_fx)); //"Total equilibrium Gibbs energy of the system, in moles (normalized) "
