...
SettingsDialog::CmApply()
{
    ...
    pVisor->setLocalDocDir(pLocalDocDir->text().toUtf8().data());
    pVisor->setRemoteHTML(pRemoteHTML->text().toUtf8().data());

    pVisor->setDefaultBuiltinTDB(pBuiltinTDB->text().toUtf8().data());
