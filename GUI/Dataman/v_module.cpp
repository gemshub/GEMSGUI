...
void TCModule::clearEditFocus()
{
    gui_logger->trace("TCModule::clearEditFocus {} ", GetName());
}

QWidget* TCModule::window()
{
    gui_logger->debug("TCModule::window {} ", GetName());
    return nullptr;
}

void TCModule::Update(bool )
{
    gui_logger->debug("TCModule::Update {} ", GetName());
}

// opens window with 'Remake record' parameters
void TCModule::MakeQuery()
{
    gui_logger->debug("TCModule::MakeQuery {} ", GetName());
}
