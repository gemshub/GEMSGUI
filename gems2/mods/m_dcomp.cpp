//-------------------------------------------------------------------
// Id: gems/mods/m_dcomp.cpp  version 2.0.0   2001
//
...
TDComp::DCthermo( int q, int p )
{
    ...
    {// woter fiches
        ...
        { // ðàñ÷èòûâàåì ñâ-âà ðàñòâîðèòåëÿ-âîäû ïî HGF
            aSta.Temp = aW.twp->TC;
            ...
            aW.twp->P = aSta.Pres;
            aW.twp->wRo  = aSta.Dens[aSpc.isat]; /* «®â­®áâì ¢®¤ë £/á¬3 */
            aW.twp->wEps = aWp.Dielw[aSpc.isat]; /* „¨¥«¥ªâà¨ç¥áª ï ¯®áâ®ï­­ ï */
//            aW.twp->wVis = aWp.Viscw[aSpc.isat]; /* ‚ï§ª®câì (¤¨­ ¬¨ç¥áª ï), ª£/¬*á¥ª */
        }
        else
        { // calculated before
            aW.twp->P = aSta.Pres;
