...
// THREEPI  =( 9.424777960769379350),    // 3.*pi
// FOURPI   =( 12.56637061435917250),    // 4.*pi
// PIQ      =( 9.869604401089357990),    // pi*pi
// TWOPIQ   =( 19.73920880217871600),    // 2*pi*pi
// FOURPIQ  =( 39.47841760435743200),    // 4.*pi*pi
// PISQRT   =( 1.772453850905515880),    // sqrt(pi)
// YPISQRT  =( 0.564189583547756279),    //1./sqrt(pi)
 PISIX    =( 0.523598775598298927),    // pi/6.
// MONESIX  =( -0.16666666666666666),    // 1./6.
// MONETHREE =( -0.33333333333333333),   // 1./3.
...
/* parameters for d- hard sphere diameter
const double R1 = (2.0451868738),
	 R2 = (-10.091689934),
	 R3 = (19.37548147),
	 R4 = (-47.718578894),
	 R5 = (22.134199352),
...
/* constants for delta*/
 ...
 P10  =(16.04724381643);
/* constants for eps
 P11  =(1.885731681671E-3),
 P12  =(-1.664862582344E-3),
 P13  =(12.10214960743),
 P14  =(34.83091171926),
 P15  =(27.44717748137);
*/
   /* constants for I1_6 integral*/
const double
 AA1  =(-0.120078459237),
 AA2  =(-.808712488307),
 AA3  =(.321543801337),
