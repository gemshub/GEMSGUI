//-------------------------------------------------------------------
// Id: gems/mods/submod/ipm_fia_bc.cpp
...
*          C - deviations (N) */
void
TProfil::MassBalanceDeviations( int N, int L, float *A, double *Y, double *B, double *C )
{
    int I,J;
    for(J=0;J<N;J++)
    {
...
*/
void TProfil::SimplexInitialApproximation( )
{
    int T,Q,*STR=0,*NMB=0;
    register int i,j,k;
    ...
    {  // Allocation of work arrays
        ...
        EPS = pa.p.EPS; //  added 13.10.00  KVC  DAK
...
// AA -
//
void TProfil::SPOS( double *P, int STR[],int NMB[],int J,int M,double AA[])
{
    int I,K;
    K=0;
    for(I=0; I<=M; I++)
...
// ......
//
void TProfil::START( int T,int *ITER,int M,int N,int NMB[],
...
// .....
//
void TProfil::NEW(int *OPT,int N,int M,double EPS,double *LEVEL,int *J0,
...
//.....
//
void TProfil::WORK(double GZ,double EPS,int *I0, int *J0,int *Z,int *ITER,
...
// ....
//
void TProfil::FIN(double EPS,int M,int N,int STR[],int NMB[],
...
//
void TProfil::Simplex(int M, int N, int T, double GZ, double EPS,
