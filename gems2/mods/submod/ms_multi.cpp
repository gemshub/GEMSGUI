//-------------------------------------------------------------------
// Id: gems/mods/submod/ms_multi.cpp  version 2.0.0   2001
//
...
void TMulti::dyn_set(int /*q*/)
{
    ...
    pm.SATNdx =(short (*)[2])aObj[ o_wi_satndx ].GetPtr();
    ...
    pm.XpsiA = (float (*)[MST])aObj[ o_wo_psia ].GetPtr();
    pm.XpsiB = (float (*)[MST])aObj[ o_wo_psib ].GetPtr();
    pm.XpsiD = (float (*)[MST])aObj[ o_wo_psid ].GetPtr();
...
void TMulti::dyn_kill(int /*q*/)
{
    ...
    pm.SATNdx =(short (*)[2])aObj[ o_wi_satndx ].Free();
    ...
    pm.XpsiA = (float (*)[MST])aObj[ o_wo_psia ].Free();
    pm.XpsiB = (float (*)[MST])aObj[ o_wo_psib ].Free();
    pm.XpsiD = (float (*)[MST])aObj[ o_wo_psid ].Free();
...
void TMulti::dyn_new(int /*q*/)
{
    ...
    { /* ADSORBTION AND ION IXCHANDG */
        pm.SATNdx = (short (*)[2])aObj[ o_wi_satndx].Alloc( pm.Ls, 2, I_ );
        ...
        pm.XpsiA = (float (*)[MST])aObj[ o_wo_psia].Alloc( pm.FIs, pm.FIat, F_ );
        pm.XpsiB = (float (*)[MST])aObj[ o_wo_psib].Alloc( pm.FIs, pm.FIat, F_ );
        pm.XpsiD = (float (*)[MST])aObj[ o_wo_psid].Alloc( pm.FIs, pm.FIat, F_ );
